...
export const Icons = {
  Behance: () => (
    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M22 7h-7v-2h7v2zm-11.5 5c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm2.3-1.1c-1.1-.9-2.5-1.4-4-1.4-3.5 0-6.4 2.9-6.4 6.4s2.9 6.4 6.4 6.4c1.6 0 3-.6 4.1-1.6.4-.4.4-1.1 0-1.4s-1.1-.4-1.4 0c-.7.7-1.7 1-2.7 1-2.4 0-4.4-2-4.4-4.4s2-4.4 4.4-4.4c.9 0 1.8.3 2.5.8.4.3 1.1.2 1.4-.2.4-.4.4-1.1.1-1.2zm11.2.1h-7v2h7v-2z"/></svg>
  ),
  Instagram: () => (
